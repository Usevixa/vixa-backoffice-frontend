...
const navigation = [
  ...
  { name: "Wallets & Balances", href: "/wallets", icon: Wallet },
  { name: "Transfers & Payouts", href: "/transfers", icon: ArrowLeftRight },
  { name: "Stablecoin Operations", href: "/stablecoin", icon: Coins },
